        ...
        do
            ...
            function Lerp(pos)
                ...
                local LerpThread = task.spawn(function()
                    LerpTable.VeloZeroThread = oldTaskSpawn(function()
                        while task.wait() do
                    ...
                    if LerpTable.VeloZeroThread then
                        task.cancel(LerpTable.VeloZeroThread)
                    end
                end)
            ...
            function collectToken(token)
                ...
                while task.wait() do
                    ...
                    if Alive and (Character.HumanoidRootPart.Position - token.Position).magnitude < 4 or token.CFrame.YVector.Y ~= 1 or (token.Position - Character.HumanoidRootPart.Position).magnitude < 4 or (tick() - startedCollecting) >= 3 then
                        if TokenTouched then break end
            ...
            function AutoFarm()
                ...
                if not findField(Character.HumanoidRootPart.Position) and not internalFlags.plantingPlanter or findField(Character.HumanoidRootPart.Position) and findField(Character.HumanoidRootPart.Position).Name ~= getgenv().SakataWare.AutoFarm.SelectedField and not internalFlags.plantingPlanter then
                    ...
                    repeat task.wait() until Thread == nil or MoveFlags.Finished or not AliveBool()
                end
                
                if not AliveBool() then return end
                ...
                if shouldIConvert() and not internalFlags.plantingPlanter and AliveBool() then
                    local Thread, ConvFlags = convertHoney()
                    repeat task.wait() until Thread == nil or ConvFlags.Finished
                end

                if SakataWare.Planters.toggle and AliveBool() then
                    internalFlags.plantingPlanter = true
                ...
                if SakataWare.AutoFarm.FarmDupedTokens and not internalFlags.plantingPlanter and AliveBool() then
                    farmDupedTokens()
                end

                local BubbleFarmed

                if getgenv().SakataWare.AutoFarm.FarmBubbles and not internalFlags.plantingPlanter AliveBool() then
                    BubbleFarmed = farmBubble()
                end

                local Farmed = farmTokens()

                if not Farmed and tick() - lastRandomFlower >= 1.5 and not internalFlags.plantingPlanter AliveBool() then
            ...
            do
                ...
                local ConvertSlider = ConvertSection:AddSlider({
                    ...
                    callback = function(value)
                        SakataWare.AutoFarm.ConvertAt = value
                    end
                })
                ...
                local ConvertBalloon = ConvertSection:AddToggle({
                    ...
                    flag = "ConvBalloons",
                    callback = function(bool)
                        SakataWare.AutoFarm.ConvBalloon = bool
                    end
                })
                ...
                local ConvertBalloonAt = ConvertSection:AddSlider({
                    ...
                    value = 30,
                    callback = function(value)
                        SakataWare.AutoFarm.ConvBalloonAt = value
                    end
                })
                ...
                local TogglePlanter = PlanterSection:AddToggle({
                    ...
                    flag = "Auto Planters",
                    callback = function(bool)
                        SakataWare.Planters.toggle = bool
                        print(bool, 69)
                    end
                })
                ...
                blacklistedNectarsDropdown = PlanterSection:AddList({
                    ...
                    callback = function(selectedOption)
                        ...
                        table.remove(SakataWare.Planters.BlacklistedNectars, table.find(SakataWare.Planters.BlacklistedNectars, selectedOption))
                ...
                PlanterSection:AddList({
                    ...
                    value = "",
                    function(value) 
                        if not table.find(SakataWare.Planters.BlacklistedNectars, value) then
                            table.insert(SakataWare.Planters.BlacklistedNectars, value)
                ...
                local AutoFarmToggle = AutoFarmSection:AddToggle({
                    ...
                    flag = "ToggleAutoFarm",
                    callback = function(bool)
                        SakataWare.AutoFarm.toggle = bool
                    end
                })
                ...
                local AutoDigToggle = AutoFarmSection:AddToggle({
                    ...
                    flag = "AutoDig",
                    callback = function(bool)
                        SakataWare.AutoFarm.autodig = bool
                    end
                })
                ...
                local FieldList = AutoFarmSection:AddList({
                    ...
                    callback = function(selected)
                        SakataWare.AutoFarm.SelectedField = selected
                    end
                })
                ...
                local FarmBubbles = AutoFarmSection:AddToggle({
                    ...
                    flag = "FarmBubbles",
                    callback = function(bool)
                        SakataWare.AutoFarm.FarmBubbles = bool
                    end
                })
                ...
                local FarmDupedTokens = AutoFarmSection:AddToggle({
                    ...
                    flag = "FarmDuped",
                    callback = function(bool)
                        SakataWare.AutoFarm.FarmDupedTokens = bool
                    end
                })
                ...
                local FaceBalloon = AutoFarmSection:AddToggle({
                    ...
                    flag = "FaceBalls",
                    callback = function(bool)
                        SakataWare.AutoFarm.FaceBalloon = bool
                    end
                })
                ...
                local MoveMethodList = MoveMethodSection:AddList({
                    ...
                    value = "Lerp",
                    callback = function(selected)
                        SakataWare.Movements.MoveMethod = selected
                    end
                })
                ...
                local LerpSteps = MoveMethodSection:AddSlider({
                    ...
                    value = 15,
                    callback = function(value)
                        SakataWare.Movements.LerpSteps = value
                    end
                })
                ...
                local LerpDelay = MoveMethodSection:AddSlider({
                    ...
                    value = 200,
                    callback = function(value)
                        SakataWare.Movements.LerpDelay = value
                    end
                })
                ...
                local TweenSpeed = MoveMethodSection:AddSlider({
                    ...
                    value = 125,
                    callback = function(value)
                        SakataWare.Movements.TweenServiceSpeed = value
                    end
                })
                ...
                local MoveTest = AutoFarmSection:AddToggle({
                    ...
                    callback = function(bool)
                        if bool then
                            ...
                            if Thread then
                                task.cancel(Thread)
                                if MoveFlags and MoveFlags.VeloZeroThread then
                                    task.cancel(MoveFlags.VeloZeroThread)
                                end
                            end
                        end
                    end
